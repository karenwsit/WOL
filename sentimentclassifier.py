...
def create_extract_features_dict(document, word_features):
...
def get_trained_classifier():
    ...
    training_set = nltk.classify.apply_features(create_extract_features_dict(WHAT DO I PUT HERE?!, word_features), training_tweets)
